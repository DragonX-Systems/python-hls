...
int main(int argc, char** argv) {
    ...
    std::vector<uint32_t> data_data_0 = {721, 112, 315, 30, 174, 258, 675};
    ...
    // Write array data for data
    std::vector<uint32_t> data_data_1 = {574, 368, 709, 970, 484};
    ...
    // Write array data for data
    std::vector<uint32_t> data_data_3 = {1000};
    ...
    // Write array data for data
    std::vector<uint32_t> data_data_4 = {0};
