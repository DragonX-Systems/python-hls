...
def spmm(A, values, row_num, row_ptr, C):
    ...
    # A: M×K matrix = 128×128 = 16384 elements
    # C: M×N matrix = 128×128 = 16384 elements
    ...
    # Total memory footprint for size 128: 
    # ~131224 bytes
    ...
    values = [1, 5, 3, 0, 2, 6, 4] * 2
    row_num = [1, 3, 2, 0, 1, 3, 2] * 2
    ...
    # This results in 4x4 = 16 block iterations
    total_ops = 0
    ...
    # pragma loop_count 4
    for i_block in range(0, M, BLOCK_SIZE):  # 4 iterations
        # Pragma: Middle loop count
        # pragma loop_count 4
        for j_block in range(0, N, BLOCK_SIZE):  # 4 iterations
            ...
            for i_local in range(BLOCK_SIZE):  # 32 iterations
                ...
                for j_local in range(BLOCK_SIZE):  # 32 iterations
                    ...
                    # pragma loop_count 6
                    for k_ptr in range(k_start, k_end):  # Scales with 128
    ...
    print(f"Total expected computations: 98304")
