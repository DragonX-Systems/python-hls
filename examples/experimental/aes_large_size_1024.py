...
def aes_encrypt_large_size(plaintext, key):
    ...
    # Block size: 1024 bytes (multiple of 16-byte AES blocks)
    # Number of AES blocks: 64
    
    # Memory size annotations for the HLS scheduler
    plaintext_memory_size = 1024  # 1024 bytes
    ...
    ciphertext = [0] * 1024
    ciphertext_memory_size = 1024  # 1024 bytes
